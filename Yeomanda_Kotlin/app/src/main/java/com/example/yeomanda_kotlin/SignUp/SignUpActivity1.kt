    ...
    fun init(){
        ...
        nextBtn.setOnClickListener {
            if(passwordEdt.text.toString().length >=8){
                if (isWoman) joinDto.sex="W" else joinDto.sex="M"
                joinDto.name=nameEdt.text.toString()
                joinDto.birth=birthEdt.text.toString()
                joinDto.email=emailEdt.text.toString()
                joinDto.password=passwordEdt.text.toString()
        ...
        certificationBtn.setOnClickListener {
            if (isValidEmail(user_email)) {
                ...
                println(emailEdt.text.toString())
